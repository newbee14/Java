    ...
    <div class="container_16">
      ...
      <div class="grid_11"> 
       ...
       <li> <a href="index.jsp">Home</a> </li>
         <li class="current"> <a href="viewservices.jsp">Services</a> </li>
