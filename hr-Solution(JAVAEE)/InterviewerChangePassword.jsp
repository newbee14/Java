...
<script type="text/javascript" src="js/passwordConfirmpassword.js"></script>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form name="ChangePasswordform" method="post" action="ChangePasswordServlet2" >
          <fieldset style="width:610px">
         <legend><h2><span>Change</span><span style="color:#40b5ff;"> Password</span></h2></legend>
      
     <center>
           <table cellspacing="5" cellpadding="5" class="sb_menu" border="0">
        	  <tr><td>Name</td><td><input type="text" name="name" value="${username}"  disabled="disabled"/></td></tr>
        	    <tr><td>Email ID</td><td><input type="text" name="email" value="${userid}"  disabled="disabled"/></td></tr>
       			<tr><td>Old Password</td><td><input type="password" name="oldpassword" onblur="checkPassword()"/></td>
       			<td><span id ="result"></span style="color:red"></td></tr>
       			<tr><td>New Password</td><td><input type="password" name="newpassword"/></td></tr>
       			<tr><td>Confirm Password</td><td><input type="password" name="confirmpassword" onblur="checkpandcp()"/></td>
       			<td><span id="pass"></span><img src="" name="image"/></td></tr>
