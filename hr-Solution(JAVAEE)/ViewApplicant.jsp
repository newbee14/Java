...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article" style="overflow:auto;height:500px;width:640px;">
          <table border="1" cellpadding="1" cellspacing="1" bordercolor="gray">
           <caption><h2>Applicant Register</h2></caption>
          <tr><td>Username</td><td>Graduation</td><td>Marks</td><td>University</td><td>Year of passing</td>
          <td>PostGraduation</td><td>Marks</td><td>University</td><td>Year of passing</td><td>Domain</td><td>Skill</td>
          </tr>
          <hr:forEach var="i" items="${View_Applicant}">
        <tr>
        <td>${i.email}</td>
        <td>${i.graduation}</td>
        <td>${i.g_marks}</td>
        <td>${i.g_university}</td>
        <td>${i.g_yof}</td>
        <td>${i.postgraduation}</td>
        <td>${i.pg_marks}</td>
        <td>${i.pg_university}</td>
        <td>${i.pg_yof}</td>
        <td>${i.domain}</td>
        <td>${i.skill}</td>
        </tr>
