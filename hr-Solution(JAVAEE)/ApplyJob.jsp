...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">	
        <div class="article">
         <table width="630" border="1" cellpadding="3" cellspacing="5" bordercolor="gray">
         <caption><h2>Recent Jobs Detail</h2></caption>
         <tr><td><h3>Jobcode</h3></td><td><h3>Jobtitle</h3></td><td><h3>Qualifications</h3></td><td><h3>Exp</h3></td><td><h3>Location</h3></td><td><h3>Package</h3></td></tr>
       
         <hr:forEach var="i" items="${jobs_att}">
         	<tr>
         		<td><h4>${i.jobcode}</h4></td>
         		<td><h4>${i.jobtitle}</h4></td>
         		<td><h4>${i.qualification}</h4></td>
         		<td><h4>${i.experience}</h4></td>
         		<td><h4>${i.location}</h4></td>
         		<td><h4>${i.salpackage}</h4></td>
         		<td><a href="ApplyJobServlet?jobcode=${i.jobcode}">Apply Job</a></td>
         	</tr>	 
         </hr:forEach>
         </table> 
