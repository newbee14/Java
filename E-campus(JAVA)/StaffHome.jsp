...
<!-- End of Slideshow codes --></td>
	...
	<div id="templatemo_main_wrapper">
    	<div id="templatemo_main">
            ...
            <div style="width:280px;height:80px;cursor:pointer;margin-top:70px">
            
            
            
            <c:choose>
            <c:when test="${staffatt.designation=='hod'}">
            	<a href="AddNoticeHOD.jsp"><img id="noticeimage" src="images/notice.png"/></a>
            </c:when>
            <c:otherwise>
            	<img id="noticeimage" src="images/notice.png" hidden="true"/>
            </c:otherwise>
            </c:choose>
            </div>
              <div class="sb_box">
