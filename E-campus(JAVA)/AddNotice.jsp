              ...
              <div id="contact_form">
                	<form method="post" name="AddNoticeByAdminForm" action="AddNoticeServlet" >
					   ...
					   <label class="uname" for="noticeid" style="width:auto"> Select The Notice You Want To Replace.. </label><br/>
                    	...
                    	<label for="description">Description:</label> <textarea style="width:550px" value="18" min="18" max="30" class="validate-subject required input_field" name="description" id="subject" required="required"></textarea>				               
                        <div class="cleaner h10"></div>
