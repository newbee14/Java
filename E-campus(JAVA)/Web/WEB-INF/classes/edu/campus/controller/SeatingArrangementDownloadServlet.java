...
public class SeatingArrangementDownloadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SeatingPlanTO sto=(SeatingPlanTO)request.getAttribute("seatingplanfileatt");
		
		filename=sto.getFilename();
