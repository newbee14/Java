...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_header">
        <div id="site_title">
          <h1><a href="#" rel="nofollow">Free CSS Templates</a></h1>
        </div>
    	...
    	<div id="templatemo_main">
              ...
              <div id="contact_form">
                	<form method="post" name="BloodDonationRegistrationForm" action="BloodDonorServlet" >
                        ...
                        <input type="text" style="width:230px" id="author" name="donorid" class="validate-email required input_field" disabled="disabled" required value="${donoridatt}"/>
                        <div class="cleaner h10"></div>
                    
                        <label for="name">Name:</label>
                        <input type="text" style="width:230px" id="author" name="name" class="validate-email required input_field" value="${nonteachingstaffatt.facultyname}" readonly="readonly"/>
                        <div class="cleaner h10"></div>
                    	...
                    	<input type="text"  class="validate-subject required input_field" name="age"  id="age" required/>				               
                        <div class="cleaner h10"></div>
                                                
                        <label for="gender">Gender</label> 
                        <div class="cleaner h10"></div>
                          <input type="text" style="width:230px" id="author" name="gender" class="validate-email required input_field" value="${nonteachingstaffatt.gender}" readonly="readonly"/>
                    	...
                    	<label for="mobilenumber">Contact Number</label>
                    	 <input type="tel" style="width:230px" class="validate-subject required input_field" name="mobilenumber" id="subject" value="${nonteachingstaffatt.phone}" readonly="readonly"/>				               
                        <div class="cleaner h10"></div>
