    	...
    	<div id="templatemo_main">
              ...
              <div id="contact_form">
                	<form method="post" name="AddEMagazine" action="AddEMagazineServlet" enctype="multipart/form-data" >
                        ...
                        <input type="text" style="width:550px" id="author2" name="username" class="validate-email required input_field" required value="${usertypeatt.username}" readonly="readonly"/>
                        <div class="cleaner h10"></div>
                        
                        <div class="cleaner h10"></div>
                        
                        <label for="name">Name:</label>
                        <input type="text" style="width:550px" id="author2" name="name" class="validate-email required input_field" required value="${useratt.name}" readonly="readonly"/>
                        <div class="cleaner h10"></div>
                        ...
                        <input type="text" style="width:550px" id="author2" name="name" class="validate-email required input_field" required value="${useratt.branch}" readonly="readonly"/>
                        <div class="cleaner h10"></div>
