...
<body  bgcolor="#567880" onload="fetch()">
<div class="header">
  <div class="bg1">
	...
	<img src="images/4.jpg" alt="" width="1000" />
		<table>
			...
			<tr>
				<td>PINCODE</td><td><Input type="text" name="pc" id="lightText" maxlength="6" style="margin-right:180px;" size="30"></td><td></td><td></td>
				
				<td>RATIONCARD NO</td><td><Input type="text" name="no" id="lightText" size="30"></td>
			</tr>
		</table>
		...
		<table style="color:black">
			...
			<tr>
			 ...
			 <tr>
				<td><div id="rationcardarea" style="width:200px;color:red;"></div></td>
			 </tr>
</table>
</form>
