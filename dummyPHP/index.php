...
<body>
	...
	<section id="navigation" class="dark-nav">
		...
		<div class="nav-inner">
			...
			<div class="site-logo fancy">
				<a href="#" id="logo-text" class="scroll logo">Gold Fitness Club
				</a>
			</div><!-- 
		    ...
		    <div class="nav-menu">
				<ul class="nav uppercase">
					...
					<li><a href="#features" class="scroll">Training</a>
                        <ul>
                         <li><a href="#">Personal Training</a></li>
                         <li><a href="#">WorkOut</a></li>
                         <li><a href="#">Health & Fitness</a></li>
                         <li><a href="#">Cardio Timing</a></li>
                         </ul>
                    </li>     
					<li><a href="#clients" class="scroll">Gallery</a>
                    <ul> 
                         </ul></li>
					<li><a href="#membership" class="scroll">Membership</a>
	...
	<section id="home" class="relative"> 	
		...
		<div class="v2 absolute">
			...
			<div class="typographic">
            	<!-- Your Logo -->
				<div class="logo">
					<img src="images/logo5.png" width="300px" height="100px" alt="Logo" />				</div>
				...
				<a href="#about" class="scroll"><i class="arrow-down fa fa-3x fa-angle-double-down"></i></a>			</div>
	...
	<section id="clients" class="container">
		...
		<div class="inner team">
			...
			<!-- Header -->
			<h1 class="header light gray3 fancy"><span class="colored">Our </span> Photo Gallery</h1>

			<!-- Description -->
			<p class="h-desc gray4"><span class="colored bold"> </span> </p>
			...
			<div class="team-members inner-details">
				...
				<div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="0">
						...
						<a class="team-image" href="slimbox-2.05/img/first2.jpg" rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first2.jpg" alt="" height="330"  />
						</a>
                ...
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="100">
						...
						<a class="team-image" href="slimbox-2.05/img/first1.jpg" rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first1.jpg"  alt="" height="330"  />
						</a>
				</div>
                    
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="100">
					
						<a class="team-image" href="slimbox-2.05/img/first3.jpg" rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first3.jpg" height="330" alt=""  />
						</a>
				</div>
                    
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="100">
					
						<a class="team-image" href="slimbox-2.05/img/first4.jpg" rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first4.jpg"height="330" alt=""  />
						</a>
				</div>
                    
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="100">
					
						<a class="team-image" href="slimbox-2.05/img/first5.jpg" rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first5.jpg" height="330" alt=""  />
						</a>
				</div>
                    
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="100">
					
						<a class="team-image" href="slimbox-2.05/img/first6.jpg" rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first6.jpg" height="330" alt=""  />
						</a>
				</div>
                    
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="100">
					
						<a class="team-image" href="slimbox-2.05/img/first7.jpg"rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first7.jpg" height="330" alt=""  />
						</a>
				</div>
                    
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="100">
					
						<a class="team-image" href="slimbox-2.05/img/first8.jpg" rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first8.jpg" height="330" alt=""  />
						</a>
				</div>
                    
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="100">
					
						<a class="team-image" href="slimbox-2.05/img/first9.jpg" rel="lightbox">
							<!-- Img -->
							<img src="slimbox-2.05/img/first9.jpg"height="330" alt=""  />
						</a>
				</div>
	...
	<footer id="footer" class="footer">
		<!-- Your Company Name -->
        <img src="images/logoo.jpg" width="200" alt="Logo" />
		<!-- Copyright -->
