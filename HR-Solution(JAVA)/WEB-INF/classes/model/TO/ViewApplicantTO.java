...
public class ViewApplicantTO {
	...
	public String getG_university() {
		return g_university;
	}
	public void setG_university(String g_university) {
		this.g_university = g_university;
	}
	public int getG_yof() {
		return g_yof;
	}
	...
	public ViewApplicantTO( String graduation, int g_marks,
			String g_university, int g_yof, String postgraduation,
			int pg_marks, String pg_university, int pg_yof, String domain,
