	...
	<div id="templatemo_main_wrapper">
    	<div id="templatemo_main">
			...
			<div id="wrapper">
                     ...
                     <form  name="ChangeStudentPasswordForm" method="post" action="StudentChangePasswordServlet"> 
                               ...
                               <p> 
                                ...
                                <tr>
									<td>
										 <p class="pswd button"> 
										 <input type="button" style="width: 200px" value="Change Password" onclick="changeStudentPassword()"/> 
										 </p>
          							</td>
          							
          						</tr>
								<tr align="right"><td><span style="width: 200px;height: 50px" id="wrongpasswordarea"></span></td></tr>	
          						</table>
                                   </form>
                        </div>
