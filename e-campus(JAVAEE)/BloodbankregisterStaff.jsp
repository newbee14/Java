    	...
    	<div id="templatemo_main">
              ...
              <div id="contact_form">
                	<form method="post" name="BloodDonationRegistrationForm" action="BloodDonorServlet" >
                        ...
                        <input type="text" style="width:230px" id="author" name="donorid" class="validate-email required input_field" disabled="disabled" required="required" value="${donoridatt}"/>
                        <div class="cleaner h10"></div>
                    
                        <label for="name">Name:</label>
                        <input type="text" style="width:230px" id="author" name="name" class="validate-email required input_field" value="${staffatt.facultyname}" readonly="readonly"/>
                        <div class="cleaner h10"></div>
                        ...
                        <div class="cleaner h10"></div>
                         <input type="text" style="width:230px" id="author" name="gender" class="validate-email required input_field" value="${staffatt.gender}" readonly="readonly"/>
                        <div class="cleaner h10"></div>
                    	...
                    	<label for="mobilenumber">Contact Number</label>
                    	 <input type="tel" style="width:230px" class="validate-subject required input_field" name="mobilenumber" id="subject" required="required" min="10" max="10" value="${staffatt.phone}" readonly="readonly"/>				               
                        <div class="cleaner h10"></div>
